...
-----OUTPUT Nextfit---------
student@student:~$ javac NextFit.java
student@student:~$ java NextFit
Enter the number of memory blocks: 3
Enter size of memory block 1: 450
Enter size of memory block 2: 50
Enter size of memory block 3: 800
Enter process name (e.g., p1) or 'exit' to quit: p1
Enter the size of memory request: 570
| p1         | 570        | Allocated  |
Memory Blocks Status:
| Block Size | Process      |
|------------|--------------|
...
Enter the size of memory request: 10
| p2         | 10         | Allocated  |
Memory Blocks Status:
| Block Size | Process      |
|------------|--------------|
...
Enter the size of memory request: 60
| p3         | 60         | Not Allocated |
Memory Blocks Status:
| Block Size | Process      |
|------------|--------------|

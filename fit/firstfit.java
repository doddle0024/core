...
--------OUTPUT Firstfit---------
student@student:~$ javac Firstfit.java
student@student:~$ java Firstfit
Enter the number of memory blocks: 4
Enter size of memory block 1: 200
Enter size of memory block 2: 50
Enter size of memory block 3: 780
Enter size of memory block 4: 500
...
Enter the size of memory request: 20
| p3         | 20         | Allocated  |
Memory Blocks Status:
| Block Size | Process      |
|------------|--------------|
